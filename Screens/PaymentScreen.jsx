        ...
        <View style={styles.container}>
          ...
          <View style={styles.pricingOption}>
            ...
            <Text style={styles.pricingOptionDescription}>
              Send and recieve 10 Rewards per day, 5 per transaction
            </Text>
            <View style={styles.pricingOptionFeatures}>
              <Text style={styles.pricingOptionFeature}>20 Users</Text>
              <Text style={styles.pricingOptionFeature}>
                Everything in free + Basic support
              </Text>
            </View>
          ...
          <View style={styles.pricingOption}>
            ...
            <Text style={styles.pricingOptionDescription}>
              Send and recieve 30 Rewards per day, 10 per transaction
            </Text>
            <View style={styles.pricingOptionFeatures}>
              <Text style={styles.pricingOptionFeature}>30 Users</Text>
              <Text style={styles.pricingOptionFeature}>
                Everything in Basic + Priority support
              </Text>
            </View>
            <Pressable style={styles.pricingOptionButtonContainer}>
              <Text style={styles.pricingOptionButton}>Choose Plan</Text>
          ...
          <View style={styles.pricingOption}>
            ...
            <Text style={styles.pricingOptionDescription}>
              Send and recieve unlimited Rewards
            </Text>
            <View style={styles.pricingOptionFeatures}>
              <Text style={styles.pricingOptionFeature}>Unlimited Users</Text>
              <Text style={styles.pricingOptionFeature}>
                Everything in pro + 24/7 support
              </Text>
            </View>
            <Pressable style={styles.pricingOptionButtonContainer}>
              <Text style={styles.pricingOptionButton}>Choose Plan</Text>
